...
The mean for the total number of steps taken each day : **`r prettyNum(mean(x=sumActivity ,na.rm = T))`**  

The median for the total number of steps taken each day : **`r prettyNum(median( x=sumActivity ,na.rm = T))`**
...
```
The **`r averageSteps[x,"interval"]`^th^**, 5-minute interval has the maximum of **`r averageSteps[x,"steps"]`** steps.
...
The total number of missing step values in the original dataset : **`r sum(missing[missing==T])`**
...
The mean for the total number of steps taken each day : **`r prettyNum(mean(x=sumNaActivity))`**  

The median for the total number of steps taken each day : **`r prettyNum(median( x=sumNaActivity))`**
